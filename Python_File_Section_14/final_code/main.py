...
# Exploring the readline() method
with open('intro.txt', 'r') as new_file:
    print(new_file.readline())

#Exploring readlines()
# This method creates a list of items take the items line by line.
with open('intro.txt', 'r') as new1_file:
    print(new1_file.readlines()) 
